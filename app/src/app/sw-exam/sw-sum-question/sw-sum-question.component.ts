...
@Component({
  selector: 'app-sw-sum-question',
  templateUrl: './sw-sum-question.component.html',
  styleUrls: ['./sw-sum-question.component.scss'],
})
export class SwSumQuestionComponent implements OnInit {
